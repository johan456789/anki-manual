...
simulate more new cards in addition to those already in this preset. For example, if you currently have 100 cards under this preset,
...
Note that just because FSRS *can* give you intervals shorter than one day doesn't necessarily mean that it *will*. Your **Again** interval can be one day long, or even longer.
